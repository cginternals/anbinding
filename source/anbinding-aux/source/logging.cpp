...
#include <anbinding-aux/logging.h>
...
#include <anbinding-aux/RingBuffer.h>
...
using FunctionCallBuffer = anbinding::aux::RingBuffer<anbinding::aux::LogEntry>;
...
std::ostream & operator<<(std::ostream & stream, const anbinding::FunctionCall * call)
{
...
{
    Binding::setLogCallback(anbinding::aux::log);
