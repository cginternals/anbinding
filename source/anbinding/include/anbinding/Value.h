...
*/
template <typename T>
class ANBINDING_TEMPLATE_API Value : public AbstractValue
{
public:
    /**
    *  @brief
    ...
    */
    ANBINDING_CONSTEXPR inline Value(const T & value);
    ...
    *    The value
    */
    ANBINDING_CONSTEXPR inline T value() const;
