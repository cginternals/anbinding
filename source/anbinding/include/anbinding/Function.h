...
*/
template <typename ReturnType, typename... Arguments>
struct ANBINDING_TEMPLATE_API CallbackType
{
...
struct ANBINDING_TEMPLATE_API CallbackType<void, Arguments...>
{
...
*/
template <typename ReturnType, typename... Arguments>
class ANBINDING_TEMPLATE_API Function : public AbstractFunction
{
public:
...
#include <anbinding/Function.inl>