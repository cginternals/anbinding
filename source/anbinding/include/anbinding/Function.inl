...
{
    inline static ReturnType call(const anbinding::Function<ReturnType, Arguments...> * function, Arguments&&... arguments)
    {
        return reinterpret_cast<typename anbinding::Function<ReturnType, Arguments...>::Signature>(function->address())(std::forward<Arguments>(arguments)...);
    }
};
...
struct BasicCallHelper<anbinding::Boolean32, Arguments...>
{
    inline static anbinding::Boolean32 call(const anbinding::Function<anbinding::Boolean32, Arguments...> * function, Arguments&&... arguments)
    {
        return reinterpret_cast<typename anbinding::Function<anbinding::Boolean32::underlying_type, Arguments...>::Signature>(function->address())(std::forward<Arguments>(arguments)...);
    }
};
...
struct FunctionHelper
{
    inline static ReturnType call(const anbinding::Function<ReturnType, Arguments...> * function, Arguments&&... arguments)
    {
        anbinding::FunctionCall functionCall(function);

        if (function->isAnyEnabled(anbinding::CallbackMask::Parameters))
        {
            functionCall.parameters = anbinding::createValues(std::forward<Arguments>(arguments)...);
        }

        if (function->isEnabled(anbinding::CallbackMask::Before))
        {
        ...
        if (function->isAnyEnabled(anbinding::CallbackMask::ReturnValue))
        {
            functionCall.returnValue = anbinding::createValue(value);
        }

        if (function->isEnabled(anbinding::CallbackMask::After))
        {
        ...
        if (function->isEnabled(anbinding::CallbackMask::Logging))
        {
...
{
    inline static void call(const anbinding::Function<void, Arguments...> * function, Arguments&&... arguments)
    {
        anbinding::FunctionCall functionCall(function);
