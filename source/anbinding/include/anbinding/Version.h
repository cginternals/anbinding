...
*  @endcode
*/
class ANBINDING_TEMPLATE_API Version
{
public:
    /**
    *  @brief
    ...
    */
    ANBINDING_CONSTEXPR inline Version();
    ...
    *    The minor version
    */
    ANBINDING_CONSTEXPR inline Version(unsigned char majorVersion, unsigned char minorVersion);
    ...
    */
    ANBINDING_CONSTEXPR inline Version(const Version & version);
    ...
    *    The major version
    */
    ANBINDING_CONSTEXPR inline unsigned char majorVersion() const;
    ...
    *    The minor version
    */
    ANBINDING_CONSTEXPR inline unsigned char minorVersion() const;
    ...
    */
    ANBINDING_CONSTEXPR inline bool isNull() const;
    ...
    */
    ANBINDING_CONSTEXPR inline bool operator<(const Version & version) const;
