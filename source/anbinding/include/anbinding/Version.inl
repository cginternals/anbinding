...
ANBINDING_CONSTEXPR Version::Version()
: m_major(0)
, m_minor(0)
{
}

ANBINDING_CONSTEXPR Version::Version(unsigned char majorVersion, unsigned char minorVersion)
: m_major(majorVersion)
, m_minor(minorVersion)
{
}

ANBINDING_CONSTEXPR Version::Version(const Version & version)
...
ANBINDING_CONSTEXPR unsigned char Version::majorVersion() const
{
    return m_major;
}

ANBINDING_CONSTEXPR unsigned char Version::minorVersion() const
{
    return m_minor;
}
...
ANBINDING_CONSTEXPR bool Version::isNull() const
{
    return m_major == 0;
}
...
ANBINDING_CONSTEXPR bool Version::operator<(const Version & version) const
{
