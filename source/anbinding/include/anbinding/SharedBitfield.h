...
class ANBINDING_TEMPLATE_API SharedBitfield;
...
struct ANBINDING_TEMPLATE_API is_member_of_SharedBitfield
{
...
struct ANBINDING_TEMPLATE_API is_member_of_SharedBitfield<T, U, Types...>
{
...
struct ANBINDING_TEMPLATE_API prepend_to_SharedBitfield
{
};
...
*/
template<typename T, typename... Types>
struct ANBINDING_TEMPLATE_API prepend_to_SharedBitfield<T, SharedBitfield<Types...>>
{
...
*/
template<typename, typename>
struct ANBINDING_TEMPLATE_API intersect_SharedBitfield
{
...
struct ANBINDING_TEMPLATE_API intersect_SharedBitfield<SharedBitfield<T, Types...>, SharedBitfield<OtherTypes...>>
{
...
*/
template <typename T>
class ANBINDING_TEMPLATE_API SharedBitfieldBase
{
public:
    ...
    */
    ANBINDING_CONSTEXPR inline SharedBitfieldBase(T value);
    ...
    *    The bitfield value
    */
    ANBINDING_CONSTEXPR inline explicit operator T() const;
...
class ANBINDING_TEMPLATE_API SharedBitfield<Type> : public SharedBitfieldBase<typename std::underlying_type<Type>::type>
{
public:
    ...
    */
    ...
    ANBINDING_CONSTEXPR inline SharedBitfield(ConstructionType value);
    ...
    *    The value of this SharedBitfield
    */
    ANBINDING_CONSTEXPR inline SharedBitfield(typename std::underlying_type<Type>::type value);
    ...
    */
    ANBINDING_CONSTEXPR inline operator Type() const;
    ...
    */
    template <typename... T>
    ANBINDING_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    ANBINDING_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    ANBINDING_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type>::value, bool>::type;
};
...
class ANBINDING_TEMPLATE_API SharedBitfield<Type, Types...> : public SharedBitfield<Types...>
{
public:
    ...
    */
    template <typename... T>
    ANBINDING_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    ANBINDING_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    ANBINDING_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type, Types...>::value, bool>::type;
};
...
ANBINDING_CONSTEXPR inline typename std::enable_if<std::is_base_of<SharedBitfieldBase<typename std::underlying_type<typename std::enable_if<std::is_enum<Enum>::value, Enum>::type>::type>, ConvertibleEnum>::value, Enum>::type
...
#include <anbinding/SharedBitfield.inl>