...
*/
ANBINDING_CONSTEXPR inline CallbackMask operator~(CallbackMask a);
...
*/
ANBINDING_CONSTEXPR inline CallbackMask operator|(CallbackMask a, CallbackMask b);
...
#include <anbinding/CallbackMask.inl>