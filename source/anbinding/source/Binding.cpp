...
void Binding::initialize(const anbinding::GetProcAddress functionPointerResolver, const bool _resolveFunctions)
{
...
anbinding::GetProcAddress & Binding::s_getProcAddress()
{
    static anbinding::GetProcAddress getProcAddress = nullptr;
